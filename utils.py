...
def get_spectrograms(fpath):
    ...
    mag = np.abs(linear)  # (1+n_fft//2, T) 1025 , T

    # mel spectrogram
    mel_basis = librosa.filters.mel(sr=hp.sr, n_fft=hp.n_fft, n_mels=hp.n_mels)  # (n_mels, 1+n_fft//2) 80, 1025
    ...
    # normalize     # ref_db = 20 # max_db = 100
